...
function EditMerchForm (props) {
  ...
  function handleEditMerchFormSubmission(event) {
    ...
    props.onEditMerch({name: event.target.name.value, description: event.target.description.value, quantity: event.target.quantity.value, price: event.target.price.value, id: merch.id});
  }
